...
RUN     jlink \
        ...
        --compress=2 \
        --add-modules
        jdk.management.agent, java.base,java.lgging, java.xml, jdk.unsupported, java.sql, java.naming, java.desktop, java.management, java.security.jgss, java.instrument, java.scripting, jdk.crypto.ec, java.rmi, jdk.httpserver, jdk.zips, jdk.net \
        --scrit-debug \
        --no-header-files \
        --no-man-pages \
